...
#define	sc_r1	sc_edx
	...
	int	sc_sp;			/* sp to restore */
	int	sc_pc;			/* pc to retore */
	int	sc_g2;			/* g2 to restore */
# ifndef __s390x
	int	sc_g3;			/* g3 to restore */
# endif
#endif
};
...
#endif
#if defined(__s390)
#define	    ILL_ILLINSTR_FAULT  0x00	/* Operation exception */
#define	    ILL_PRIVINSTR_FAULT 0x06	/* Privileged instruction exception */
#endif

...
#elif	defined(DO_RELOC_LIBLD_S390)

#define	DO_RELOC_LIBLD
#if	defined(_ELF64)
#define	do_reloc_ld		do64_reloc_ld_s390
#define	reloc_table		reloc64_table_s390
#else
#define	do_reloc_ld		do32_reloc_ld_s390
#define	reloc_table		reloc32_table_s390
#endif
...
extern const char	*conv_reloc_S390X_type(Word);
#define	CONV_RELOC_TYPE conv_reloc_S390X_type

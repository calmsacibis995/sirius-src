...
/*
 * Next set of definitions characterize Solaris on s390x platform.
 */
#elif defined(__s390x) || defined(__s390x__) || defined(__s390) || defined(__s390__)
...
/*
 * Next defines common features between 32 and 64 bit 
 */
# define _MULTI_DATAMODEL
# define _BIG_ENDIAN
# define _STACK_GROWS_DOWNWARD

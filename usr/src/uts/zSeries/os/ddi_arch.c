...
/* Name        - ddi_arch.c 					    */
/* 								    */
/* Function    - Architectural specific DDI support routines.       */
/* 								    */
/* Name	       - Neale Ferguson					    */
/* 								    */
/* Date        - June, 2007  					    */
...
/* Name		- i_ddi_bus_map.                                    */
/*                                                                  */
/* Function	- Generic bus_map entry point for byte addressable  */
/*		  devices conforming to the reg/range addressing    */
/*		  model with no HAT layer to be programmed at this  */
/*		  level.                       		 	    */
/*		                               		 	    */
/*------------------------------------------------------------------*/
	...
	off_t offset, off_t len, caddr_t *vaddrp)
{
	 ...
	 *	<bustype>1, addr=0, len=x>: s390x-compatibility i/o
	 */
...
/*------------------------------------------------------------------*/
/*                                                                  */
/* Name		- i_ddi_rnumber_to_regspec.                         */
/*                                                                  */
/* Function	- Creating register mappings & handling interrupts. */
/*		                               		 	    */
/*------------------------------------------------------------------*/
...
/*------------------------------------------------------------------*/
/*                                                                  */
/* Name		- reg_is_enclosed_in_range.                         */
/*                                                                  */
/* Function	- Determine if a reg prop is enclosed within a      */
...
/*------------------------------------------------------------------*/
/*                                                                  */
/* Name		- i_ddi_apply_range.                                */
/*                                                                  */
/* Function	- Apply range of dp to struct regspec *rp, if       */
/*		  applicable. If there's any range defined then it  */
/*		  gets applied.                		 	    */
/*		                               		 	    */
/*------------------------------------------------------------------*/
...
/*------------------------------------------------------------------*/
/*                                                                  */
/* Name		- i_ddi_map_fault.                                  */
/*                                                                  */
/* Function	- Wrapper for bus_map_fault.                        */
/*		                               		 	    */
/*------------------------------------------------------------------*/
...
/*------------------------------------------------------------------*/
/*                                                                  */
/* Name		- impl_ddi_prop_int_from_prom.                      */
/*                                                                  */
/* Function	- Return an integer in native machine format from   */
/*		  an OBP 1275 integer (which is also big endian).   */
/*		  intp points to the OBP data and n is the number   */
/*		  of bytes.                    		 	    */
/*		                               		 	    */
/*------------------------------------------------------------------*/

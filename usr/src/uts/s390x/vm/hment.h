 ...
 * freed via hment_free() after doing s390x_hm_exit().
 */
 ...
 */
extern void s390x_hm_enter(page_t *);
extern void s390x_hm_exit(page_t *);
extern int s390x_hm_held(page_t *pp);

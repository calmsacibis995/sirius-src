...
1:
	...
	sr	%r1,%r4			// Determine length

	//
	// At this stage r1 is the length of the string
	//
	lr	%r2,%r4			// Point at start of string
	lr	%r0,%r3			// Get byte to scan for
	ar	%r1,%r2			// Point at end of string
2:
	srst	%r1,%r2			// Search for our byte of interest
	jo	2b			// Keep going if there's nore to do
	brc	13,3f			// Found - let's go
	lhi	%r1,0			// Indicate not found
3:
	lr	%r2,%r1			// Copy result
	br	%r14			// Return
	SET_SIZE(strchr)

 ...
 */
	...
	lr	%r4,%r3			// Handler address
	st	%r14,UL_UNWIND_RET(%r1) // Save caller's return address
	basr	%r14,%r4		// Call handler
	GET_THR(1)			// Get thread pointer
	l	%r14,UL_UNWIND_RET(%r1) // Restore return address
	lr	%r2,%r15		// Frame pointer is the arg register
	jg	_t_cancel		// Cancel

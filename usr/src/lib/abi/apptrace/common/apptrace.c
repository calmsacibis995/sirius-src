...
la_s390x_pltenter(Elf64_Sym *symp, uint_t symndx, uintptr_t *refcookie,
	uintptr_t *defcookie, La_s390x_regs *regset, uint_t *sb_flags,
	char const *sym_name)
#elif  defined(__s390)
uintptr_t
la_s390_pltenter(Elf64_Sym *symp, uint_t symndx, uintptr_t *refcookie,
	uintptr_t *defcookie, La_s390_regs *regset, uint_t *sb_flags)
#endif
{

...
#define	GETARG0(regset)		regset->lr_reg2
#define	GETARG1(regset)		regset->lr_reg3
#define	GETARG2(regset)		regset->lr_reg4
#define	GETARG3(regset)		regset->lr_reg5
#define	GETARG4(regset)		regset->lr_reg6
#define	GETARG5(regset)		(((ulong_t *)regset->lr_reg15)[25])

#define	GETARG_6NUP(i, regset)	(((ulong_t *)regset->lr_reg15)[i+25])

#define	GETFRAME(regset)	(regset->lr_reg15)
#define	GETPREVPC(regset)	(*(uintptr_t *)regset->lr_reg15)

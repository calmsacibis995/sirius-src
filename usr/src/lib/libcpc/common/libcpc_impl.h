...
#if defined(__sparc) || defined(__i386) || defined(__s390)
/*
...
#define CPC_SYSTEM_Z9		4000
#define CPC_SYSTEM_Z10		4000

#endif /* __sparc || __i386 || __s390 */

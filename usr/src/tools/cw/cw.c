...
#elif defined(__sparc) && !defined(__s390)
...
#endif
#if defined(__s390)
	"z990",		"-mtune=z990", NULL,
	"z9",		"-mtune=z9-109", NULL,
#endif
	NULL,		NULL
};
...
warnings(struct aelist *h)
{
	...
	newae(h, "-Wno-switch");
	newae(h, "-Wno-int-to-pointer-cast");
	newae(h, "-Wno-pointer-to-int-cast");
}

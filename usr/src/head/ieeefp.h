 ...
 *
 * NOTE: the bit positions in an fp_except are chosen to match that in
 * the Trap Enable Mask of the FPC (Floating Point Control Register).
 */

/* an fp_except can have the following (not exclusive) values: */
#define	FP_X_INV	0x80	/* invalid operation exception */
#define	FP_X_DZ		0x40	/* divide-by-zero exception */
#define	FP_X_OFL	0x20	/* overflow exception */
#define	FP_X_UFL	0x10	/* underflow exception */
#define	FP_X_IMP	0x08	/* inexact (loss of precision) */

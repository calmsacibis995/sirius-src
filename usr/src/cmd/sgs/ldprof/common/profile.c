...
uintptr_t
la_s390x_pltenter(Elf64_Sym *symp, uint_t symndx, uintptr_t *refcookie,
	uintptr_t *defcookie, La_s390x_regs *regset, uint_t *sbflags,
	const char *sym_name)
#elif	defined(__s390)
uintptr_t
la_s390_pltenter(Elf32_Sym *symp, uint_t symndx, uintptr_t *refcookie,
	uintptr_t *defcookie, La_s390_regs *regset, uint_t *sbflags)
#else
...
#elif defined(__s390x)
	/*
	 * The callers return address for s390x
	 */
	from = *(caddr_t *)(regset->lr_reg14);
#elif defined(__s390)
	/*
	 * The callers return address for s390
	 */
	from = *(caddr_t *)(regset->lr_reg14);
#else
#error unexpected architecture!

...
SGSMSGZSERIES=  ../common/rtld.zSeries.msg
SGSMSGZSERIES32=../common/rtld.zSeries32.msg
SGSMSGZSERIES64=../common/rtld.zSeries64.msg
...
SGSMSGALL=	$(SGSMSGCOM) $(SGSMSG32) $(SGSMSG64) \
		...
		$(SGSMSGZSERIES) $(SGSMSGS39032) $(SGSMSGS39064)
